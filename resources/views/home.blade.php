<x-layouts.app :title="$title">
    ...
    <div class="container mt-4" x-data="{ openEditar: false, openExibir: true }">
        <div class="row mb-4">
            <div class="col-6">
                <button @click="openEditar = true; openExibir = false" class="btn btn-primary d-flex align-items-center mx-auto justify-content-center" style="width: 100%;">
            ...
            <div class="col-6">
                <button @click="openExibir = true; openEditar = false" class="btn btn-success d-flex align-items-center mx-auto justify-content-center" style="width: 100%;">
